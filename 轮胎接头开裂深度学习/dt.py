...
#     os.makedirs(path)
# if not os.path.exists(path+"/detection-results"):
#     os.makedirs(path+"/detection-results")
# if not os.path.exists(path+"/images-optional"):
#     os.makedirs(path+"/images-optional")
...
for image_id in image_ids:
    ...
    # image_path = "../ImageGenerator/normal/" + image_id + ".jpg"
    image = Image.open(image_path)
    image.save(path+"/images-optional/" + image_id + ".jpg")
    frcnn.detect_image(image_id, image)
    print(image_id, " done!")

print("Conversion completed!")
# os.system("get_map.py")